Namespace Data
    ...
    Public Class SampleDataItem
        ...
        Public Sub New(uniqueId As String, title As String, subtitle As String, imagePath As String, description As String, content As String, program As String)
        ...
        Private Async Function GetSampleDataAsync() As Task
            ...
            For Each groupValue As JsonValue In jsonArray
                ...
                For Each itemValue As JsonValue In groupObject("Items").GetArray()
                    ...
                    group.Items.Add(New SampleDataItem(itemObject("UniqueId").GetString(), itemObject("Title").GetString(), itemObject("Subtitle").GetString(), itemObject("ImagePath").GetString(), itemObject("Description").GetString(), itemObject("Content").GetString(), itemObject("Program").GetString()))
                Next
