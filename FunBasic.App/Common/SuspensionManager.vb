Namespace Common
    ...
    Friend NotInheritable Class SuspensionManager
        ...
        ''' <see cref="System.Runtime.Serialization.DataContractSerializer"/> and should be as compact as
        ...
        ''' <summary>
        ''' List of custom types provided to the <see cref="System.Runtime.Serialization.DataContractSerializer"/>
        ...
        Public Shared Async Function SaveAsync() As Task
            Try
                ...
                Dim serializer As New System.Runtime.Serialization.DataContractSerializer(GetType(Dictionary(Of String, Object)), _knownTypes)
